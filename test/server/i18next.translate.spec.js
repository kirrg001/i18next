...
describe('i18next.translate', function() {
  ...
  describe('context usage', function() {
    ...
    describe('extended usage - ensure we receive json objects', function() {
      var resStore = {
        en: {
          translation: {
            key1: '__object.nestedKey__ test'
          }
        }
      };
      ...
      it('forward mongoose object', function() {
        var mongooseObject = {
          object: {
            nestedKey: 'this is a'
          }
        ...
        expect(i18n.t('key1', mongooseObject)).to.be('1 friend');
      });
    });
